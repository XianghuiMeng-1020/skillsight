...
export const translations: Translations = {
  ...
  'resume.step2Desc': { zh: '基于六维 Rubric 的简历评分', 'zh-TW': '基於六維 Rubric 的履歷評分', en: 'Resume scored against a 6-dimension rubric' },
  ...
  'changelog.noEventsDesc': { zh: '上传文档、运行技能评估或角色就绪度后会产生变更记录。', 'zh-TW': '上傳文件、執行技能評估或角色準備程度後會產生變更記錄。', en: 'Change records are generated after uploading documents, running skill assessments, or role readiness evaluations.' },
