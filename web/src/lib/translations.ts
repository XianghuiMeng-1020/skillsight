...
export const translations: Translations = {
  ...
  'jobsLive.title': { zh: '实时职位市场', 'zh-TW': '即時職位市場', en: 'Live Job Market' },
  ...
  'jobsLive.subtitleCountMainland': { zh: '条内地实时职位 · 显示你的技能匹配度', 'zh-TW': '條內地即時職位 · 顯示你的技能匹配度', en: 'mainland China job postings · your skill match shown per listing' },
