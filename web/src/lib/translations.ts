...
export const translations: Translations = {
  ...
  'dashboard.confirmedMatches': { zh: '已匹配岗位（至少 3 项技能匹配）', 'zh-TW': '已匹配職位（至少 3 項技能匹配）', en: 'Confirmed Matches (3+ skills matched)' },
  'dashboard.potentialMatches': { zh: '潜在可解锁岗位（2 项技能匹配）', 'zh-TW': '潛在可解鎖職位（2 項技能匹配）', en: 'Potential Unlocks (2 skills matched)' },
  ...
  'dashboard.noRolesAboveThreshold': { zh: '当前暂无满足门槛（至少 2 项技能匹配）的岗位。建议先完成评估提升技能画像。', 'zh-TW': '當前暫無滿足門檻（至少 2 項技能匹配）的職位。建議先完成評估提升技能畫像。', en: 'No roles meet the threshold yet (at least 2 matched skills). Complete assessments to improve your profile.' },
  'dashboard.potentialAgentPromptTitle': { zh: '解锁潜在岗位', 'zh-TW': '解鎖潛在職位', en: 'Unlock potential roles' },
  'dashboard.potentialAgentPromptBody': { zh: '你已有 2 项匹配技能的潜在岗位。AI Agent 可以根据这些岗位建议你优先做哪些评估。', 'zh-TW': '你已有 2 項匹配技能的潛在職位。AI Agent 可根據這些職位建議你優先進行哪些評估。', en: 'You already have potential roles with 2 matched skills. The AI Agent can suggest which assessments to take first.' },
